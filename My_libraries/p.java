...
public class p {
    ...
    public static long[] IntegerFactorization(long x) {
        long[] a = {};
        while (!prime(x)) {
    ...
    public static boolean Array_element_equals(Object[] arr1, Object[] arr2) {
        long a = arr1.length;
        long b = arr2.length;
        if (a == b) {
            for (int i = 0; i <= a - 1; i ++) {
    ...
    public static Object[] Array_remove(Object a, Object[] arr) {
        int s = arr.length;
    ...
    public static Object[] Array_add(Object a, Object[] arr) {
        int s = arr.length;
        Object[] b = new Object[s + 1];
    ...
    public static boolean Array_contains(Object a, Object[] arr) {
        for (int i = 0; i <= arr.length - 1; i ++) {
            if (a == arr[i]) {
                return true;
            }
